...
//	        }
		...
		try {
			...
			ps.setTimestamp(6, bean.getCreated_DateTime());
			ps.setTimestamp(7, bean.getModified_DateTime());
			ps.executeUpdate();
			conn.commit();
			ps.close();
		} catch (Exception e) {
	...
	public RoleBean findByName(String name) throws ApplicationException {
		...
		try {
			...
			while (rs.next()) {
	            ...
	            bean.setCreate_DateTime(rs.getTimestamp(6));
	            bean.setModified_DateTime(rs.getTimestamp(7));
			}
			rs.close();
		} catch (Exception e) {
	 ...
	 */
	 public void update(RoleBean bean) throws ApplicationException, DatabaseException, DuplicateRecordException {
		 ...
		 try {
			...
			ps.setTimestamp(5, bean.getCreated_DateTime());
			ps.setTimestamp(6, bean.getModified_DateTime());
